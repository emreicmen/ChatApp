...
extension LoginViewController {
    func updateUserInfo() {
        ...
        getImageFromGoogleProfile(withImageUrl: photoUrl) { image in
            let credential = AuthCredentialEmail(email: email, uid: uid, fullName: fullName, userName: userName, profileImage: image)
